...
class BasicSceneGraphEvaluator:
    def __init__(self, mode, AG_object_classes, AG_all_predicates, AG_attention_predicates, AG_spatial_predicates, AG_contacting_predicates,
        ...
        self.result_dict = {}
        self.mode = mode
        self.result_dict[self.mode + '_recall'] = {5: [], 10: [], 20: [], 50: [], 100: []}
    ...
    def evaluate_scene_graph(self, gt, pred):
        ...
        for idx, frame_gt in enumerate(gt):
            ...
            # for visualization
            pred_entry['pred_to_gt'] = pred_to_gt
            pred_entry['pred_5ples'] = pred_5ples
            pred_entry['rel_scores'] = rel_scores
            all_pred_entry.append(pred_entry)

        return all_pred_entry
