...
from lib.transformer_baseline_STTran import transformer
...
class STTran(nn.Module):
    ...
    def __init__(self, mode='sgdet',
        ...
        embed_vecs = obj_edge_vectors(obj_classes, wv_type='glove.6B', wv_dir='/home/zztao/dev/neural-motifs/data', wv_dim=200)
