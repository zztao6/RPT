...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data, im_info, gt_boxes, num_boxes):
        ...
        # feed image dataset to base model to obtain base feature map
        ...
        if cfg.POOLING_MODE == 'align':
            ...
            pooled_feat = torchvision.ops.roi_align(base_feat, rois.view(-1, 5), (7, 7), 1.0/16.0, 0, True)
        ...
        pooled_feat = pooled_feat.view(batch_size, rois.size(1), -1) # remove if train object detector
