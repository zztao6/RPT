...
class imagenet(imdb):
    def __init__(self, image_set, devkit_path, data_path):
        ...
        synsets_image = sio.loadmat(os.path.join(self._devkit_path, 'dataset', 'meta_det.mat'))
        synsets_video = sio.loadmat(os.path.join(self._devkit_path, 'dataset', 'meta_vid.mat'))
    ...
    def _load_imagenet_annotation(self, index):
        ...
        # Load object bounding boxes into a dataset frame.
